...
import foodstore.dao.ProductDao;
import foodstore.domain.PageBean;
import foodstore.domain.Product;
import foodstore.exception.AddProductException;
import foodstore.exception.FindProductByIdException;
import foodstore.exception.ListProductException;
public class ProductService {
	...
	public PageBean findBookByName(int currentPage, int currentCount,
		...
		try {
			...
			e.printStackTrace();
			throw new RuntimeException("前台搜索框查询失败！");
		}
	}
	//后台系统，根据id删除商品信息
	public void deleteProduct(String id) {
		try {
			...
			throw new RuntimeException("后台系统删除商品信息失败！");
		}
	}
}
